...
# LINK: https://www.section.io/engineering-education/how-to-set-up-and-configure-redis-caching-for-wordpress/
...
# If you run this wp command just 'wp', you will see this message.
